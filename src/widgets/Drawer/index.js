...
const Index = ({
	...
	onItemPressed = () => {},
	bottomBtn = {
		text: 'Powered by Shobbr',
		onPress: () => Linking.openURL('https:shobbr.com'),
	},
	children,
}) => {
			...
			<LinearGradient style={styles.container} colors={['#C07037', '#C55234']}>
				<View style={styles.menuContainer}>
					<Animatable.View style={styles.header} animation={active ? 'slideInDown' : 'slideOutUp'} duration={2000}>
						...
						<Text style={styles.appName}>SHOTOE</Text>
					</Animatable.View>
					...
					<Animatable.View style={styles.bottom} animation={active ? 'slideInUp' : 'slideOutDown'} duration={2000}>
						...
						<Animatable.View animation="pulse" easing="ease-out" iterationCount="infinite">
							<TouchableOpacity style={styles.bottomBtn} activeOpacity={0.7} onPress={() => Linking.openURL('https://shotoe.tech')}>
								<Text style={styles.bottomBtnTxt}>Visit Website!</Text>
							</TouchableOpacity>
						</Animatable.View>
					</Animatable.View>
				</View>
